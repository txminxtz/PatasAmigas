...
<body>
	...
	<form name="frmAnimal" action="animal_tutor_insert" method="POST"  enctype="multipart/form-data">
		<table>
			...
			<tr>
				<td>Espécie:</td>
				<td><input type="text" name="animal_especie" placeholder="Especie" class="Caixa1"></td>
			</tr>
			<tr>
				<td>Raça:</td>
			...
			<tr>
				<td>Sexo:</td>
				<td><input type="text" name="animal_sexo" id="color" list="colors" placeholder="Sexo" class="Caixa1"></td>
 			</tr>
		<tr>
			<td>Foto:</td>
